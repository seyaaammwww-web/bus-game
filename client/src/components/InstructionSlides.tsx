...
const slides: Slide[] = [
    {
        ...
        icon: <Bus className="w-20 h-20 text-[#31093A]" />,
        color: "text-primary",
        bgColor: "bg-primary"
    },
    {
        ...
        icon: <Sparkles className="w-20 h-20 text-[#31093A]" />,
    ...
    },
    {
        ...
        icon: <Plus className="w-20 h-20 text-[#31093A]" />,
    ...
    },
    {
        ...
        icon: <Lightbulb className="w-20 h-20 text-[#31093A]" />,
    ...
    },
    {
        ...
        icon: <UserX className="w-20 h-20 text-[#31093A]" />,
    ...
    },
    {
        ...
        icon: <Trophy className="w-20 h-20 text-[#31093A]" />,
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="absolute inset-0 bg-[#2C0834]/80 backdrop-blur-sm"
                onClick={onClose}
            />
            ...
            >
                <RetroCard className="p-0 overflow-hidden shadow-2xl">
                    <button
                        onClick={onClose}
                        className="absolute top-4 right-4 p-2 rounded-full bg-[#2C0834]/10 hover:bg-[#2C0834]/20 transition-colors z-20"
                    >
                        <X className="w-6 h-6 text-[#2C0834]" />
                    </button>

                    <div className="relative h-56 sm:h-64 flex items-center justify-center overflow-hidden border-b-[3px] border-[#2C0834] bg-[#FFFEF0]">
                        <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(#2C0834 1px, transparent 1px)', backgroundSize: '16px 16px' }}></div>
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                className={`w-32 h-32 ${slides[currentSlide].bgColor} flex items-center justify-center rounded-2xl shadow-[4px_4px_0_0_#2C0834] border-[3px] border-[#2C0834]`}
                            >
                    ...
                    <div className="p-8 text-center bg-[#FFFDD1]">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <h2 className="text-2xl font-bold font-pixel-title mb-4 text-[#31093A]">
                                    {slides[currentSlide].title}
                                </h2>
                                <p className="text-sm sm:text-base text-[#31093A]/80 leading-relaxed font-pixel-text">
                        ...
                        <div className="mt-10 flex flex-col gap-4">
                            <div className="flex items-center justify-center gap-2 mb-2">
                                {slides.map((_, i) => (
                                    <div
                                        key={i}
                                        className={`h-3 transition-all duration-300 border border-[#2C0834] ${i === currentSlide ? 'w-8 bg-[#31093A]' : 'w-3 bg-[#FFFDD1]'
                                            }`}
                                    />
                                ))}
                            </div>
