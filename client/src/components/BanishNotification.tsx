      ...
      {show && isBanished && (
        ...
        >
          ...
          <motion.div
            ...
            className="bg-[#350D7A] px-12 py-10 rounded-sm shadow-pixel-xl flex flex-col items-center gap-6 border-4 border-[#FFFEE2] relative z-10"
          >
            <motion.span
            ...
            <div className="h-1 w-32 bg-[#FFFEE2] relative z-10" />
