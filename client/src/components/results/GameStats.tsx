                ...
                <div className="space-y-2">
                    {gameStats.fastestPlayer && (
                        <motion.div
                            ...
                            className="flex items-center gap-3 px-3 py-2 rounded-xl border-[2px] font-pixel-text text-sm bg-white border-[#350D7A]/20"
                        >
                    ...
                    {gameStats.mostUnique && (
                        <motion.div
                            ...
                            className="flex items-center gap-3 px-3 py-2 rounded-xl border-[2px] font-pixel-text text-sm bg-white border-[#350D7A]/20"
                        >
                            <div className="w-8 h-8 rounded-lg flex items-center justify-center font-bold flex-shrink-0 bg-gradient-to-br from-[#6714A8] to-[#871BB7] shadow-sm">
