    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                exit={{ y: -50, opacity: 0 }}
                className="fixed top-4 right-4 z-50 flex items-center gap-2 md:gap-3 bg-[#2e1065]/90 border-[3px] border-[#fbbf24] shadow-[0_0_15px_rgba(251,191,36,0.5)] rounded-2xl p-2 backdrop-blur-md"
            >
