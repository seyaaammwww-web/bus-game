    ...
    <div className="absolute inset-0 pointer-events-none focus-arrows overflow-visible z-0">
        <div className="absolute top-1/2 -translate-y-1/2 -left-3 lg:-left-6">
            <svg fill="none" height="18" viewBox="0 0 24 18" width="24" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect fill="#350D7A" height="10" style={{ fill: '#350D7A', fillOpacity: 1 }} width="2" y="4"></rect>
                <rect fill="#350D7A" height="2" style={{ fill: '#350D7A', fillOpacity: 1 }} width="2" x="2" y="2"></rect>
                <rect fill="#FFFEF0" height="2" style={{ fill: '#FFFEF0', fillOpacity: 1 }} width="2" x="2" y="4"></rect>
                <rect fill="#350D7A" height="2" style={{ fill: '#350D7A', fillOpacity: 1 }} width="2" x="2" y="14"></rect>
                <rect fill="#FFE8AD" height="2" style={{ fill: '#FFE8AD', fillOpacity: 1 }} width="2" x="2" y="12"></rect>
                <rect fill="#350D7A" height="2" style={{ fill: '#350D7A', fillOpacity: 1 }} width="2" x="22" y="8"></rect>
                <rect fill="#350D7A" height="2" style={{ fill: '#350D7A', fillOpacity: 1 }} width="6" x="4"></rect>
                <rect fill="#350D7A" height="2" style={{ fill: '#350D7A', fillOpacity: 1 }} width="6" x="4" y="16"></rect>
                <rect fill="#FFFEF0" height="2" style={{ fill: '#FFFEF0', fillOpacity: 1 }} width="6" x="4" y="2"></rect>
                <rect fill="#350D7A" height="2" style={{ fill: '#350D7A', fillOpacity: 1 }} width="4" x="10" y="14"></rect>
                <rect fill="#350D7A" height="2" style={{ fill: '#350D7A', fillOpacity: 1 }} width="4" x="10" y="2"></rect>
                <rect fill="#FFE8AD" height="2" style={{ fill: '#FFE8AD', fillOpacity: 1 }} width="6" x="4" y="14"></rect>
                <rect fill="#350D7A" height="2" style={{ fill: '#350D7A', fillOpacity: 1 }} width="4" x="14" y="4"></rect>
                <rect fill="#350D7A" height="2" style={{ fill: '#350D7A', fillOpacity: 1 }} width="4" x="14" y="12"></rect>
                ...
                <rect fill="#350D7A" height="2" style={{ fill: '#350D7A', fillOpacity: 1 }} width="4" x="18" y="6"></rect>
                <rect fill="#350D7A" height="2" style={{ fill: '#350D7A', fillOpacity: 1 }} width="4" x="18" y="10"></rect>
            </svg>
        </div>
    ...
    return (
        <motion.div
            ...
            className={cn(
                ...
                "border-[3px] border-[#350D7A] rounded-sm",
                "shadow-pixel",
                bgColor,
                className
            )}
        ...
        >
            ...
            <div className="absolute inset-[3px] border border-[#350D7A]/10 pointer-events-none" />

            <QuoteArrows />

            {title && (
                <div className="mb-2 font-pixel-title text-sm uppercase tracking-widest text-[#350D7A]/60">
                    {title}
                </div>
            )}

            <div className="relative z-10 text-[#350D7A] font-pixel-text leading-relaxed">
                {children}
            </div>
        </motion.div>
    )
