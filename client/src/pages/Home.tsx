            ...
            <div className="relative h-[480px] md:h-[520px] overflow-hidden rounded-3xl border-[6px] border-[#4c1d95] shadow-[8px_8px_0_#2e1065] bg-gradient-to-b from-[#1a0533]/90 to-[#2e1065] backdrop-blur-md">
              ...
              <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none opacity-30">
                {[...Array(20)].map((_, i) => (
                  <motion.div
                    key={`rain-${i}`}
                    className="absolute w-[2px] bg-[#e9d5ff] h-[15px]"
                    style={{ left: `${Math.random() * 100}%`, top: `-${Math.random() * 20}%` }}
                    animate={{ y: ['0vh', '100vh'] }}
                    transition={{ duration: 0.6 + Math.random() * 0.4, repeat: Infinity, ease: 'linear' }}
                  />
                ))}
                {[...Array(15)].map((_, i) => (
                  <motion.div
              ...
              <div className="absolute bottom-0 w-full h-[180px] bg-gradient-to-t from-[#1a0533] via-[#2e1065] to-transparent pointer-events-none z-10 border-t-2 border-[#4c1d95]/30">
                {/* Horizontal Neon Lines */}
                <div className="absolute top-[40%] w-full h-[1px] bg-[#7c3aed]/40" />
                <div className="absolute top-[70%] w-full h-[2px] bg-[#fbbf24]/20" />
              </div>
              ...
              {[...Array(4)].map((_, i) => (
                <motion.div
                  ...
                  style={{ left: `${20 + i * 20}%`, bottom: `140px` }}
                  animate={{ y: [0, -10, 0] }}
                  transition={{ duration: 2 + i * 0.3, repeat: Infinity, ease: 'easeInOut' }}
                >
                  <PixelAvatar src={`https://api.dicebear.com/7.x/pixel-art/svg?seed=passengerv3${i}&backgroundColor=transparent`} size="sm" />
                </motion.div>
              ))}
